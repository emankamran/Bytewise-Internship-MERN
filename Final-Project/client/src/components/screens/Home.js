...
const Home = () => {
    ...
    return (
      <div className="home">
              ...
              <div className="Post-user">
                <div className="Post-user-avatar">
                  <Link to={item.postedBy && item.postedBy._id !== state?._id ? "/profile/" + item.postedBy._id : "/profile"}>
                    <img src={item.postedBy && item.postedBy.pic} />
                  </Link>
                </div>
                <div className="Post-user-nickname">
                  <Link to={item.postedBy && item.postedBy._id !== state?._id ? "/profile/" + item.postedBy._id : "/profile"}>
                    <span>{item.postedBy && item.postedBy.name}</span>
                  </Link>
                  <br />
                    ...
                    <div className="Comment-user" key={record._id}>
                      <div>
                        <div className="Comment-user-avatar">
                          ...
                          >
                            <img src={record.postedBy && record.postedBy.pic} />
                          </Link>
                        </div>
                      </div>
        ...
        {!data && state === null && (
          <p>You are logged out. Please log in to view the content.</p>
        )}
      </div>
    );
        }
